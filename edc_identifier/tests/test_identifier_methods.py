...
class TestIdentifierMethods(TestCase):
    ...
    def test_encoding(self):
        ...
        print('instantiate edc_identifier')
    ...
    def test_create(self):
        ...
        print('instantiate edc_identifier')
        identifier = Identifier(identifier_type='subject', site_code=site_code, mm=mm, yy=yy)
        print('assert that first edc_identifier is 5YSHU')
        ...
        print('create another edc_identifier, should be 5YSI5')
        ...
        print('assert edc_identifier.edc_identifier is set')
        self.assertEqual(IdentifierTracker.objects.get(identifier='5YSI5').identifier, '5YSI5')
        print('instantiate another edc_identifier where site code is 20 and include protocol 041')
        ...
        print('create another edc_identifier')
        ...
        print("assert next edc_identifier is 2K2F2E4R if root segment is provided (20041021313) and no check digit and do not add one.")
        ...
        print('and edc_identifier instance decodes it to the same value')
        ...
        print('which edc_identifier decodes to 2004102131323, note it added the counter=2, check digit=3')
